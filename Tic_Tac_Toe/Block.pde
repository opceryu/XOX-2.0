class block {
  ...
  void drawBlock(){
    ...
    if(splitedRight && splitedLeft && 
    (topOwner + bottomOwner + leftOwner + rightOwner >= 1 || topOwner + bottomOwner + leftOwner + rightOwner <= -1) &&
    topOwner != 0 && bottomOwner != 0 && rightOwner != 0 && leftOwner != 0){
      claimed = true;
      if(topOwner != 0 && (topOwner == rightOwner || topOwner == leftOwner)){
        owner = topOwner;
      }
      else {
        owner = leftOwner;
    ...
    else if(splitedRight && topRightOwner == bottomLeftOwner && topRightOwner != 0){
      claimed = true;
      owner = topRightOwner;
    }
    
    else if(splitedLeft && topLeftOwner == bottomRightOwner && topLeftOwner != 0){
      claimed = true;
      owner = topLeftOwner;
    }
